...
Analogous to the physical theory, the ${\rm AdS}_7 \times S^4$ background in the holomorphic twist will arise by backreacting $M5$ branes. To this effect, we begin by discussing how the 11d theory couples to M5 branes. Consider a stack of $N M5$ branes wrapping 
\[
...
Indeed, $\mu^{1,3}$ is a component of the Hodge star of the $G$-flux in the physical theory \ref{s:components}. 
...
We obtain further justification for this coupling through dimensional reduction to type IIA. 
...
Before getting to the proof, we introduce the relevant cohomology theory. 
