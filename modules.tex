...
%By the BV relation, the left hand side is 
%\[
% \{\eta, \div(\gamma \div \gamma')\} = \{\eta, \{\gamma, \div \gamma'\}\} + \{\eta, (\div\gamma) (\div \gamma')\}.
% \]
\end{proof}
...
\brian{Maybe we need to symmetrize to use $[\eta, \gamma, \gamma']_3 = \{\eta, \{\gamma, \gamma'\}\}$.}
\end{proof}
