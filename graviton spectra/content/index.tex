...
\[
\Omega^{0,\bullet}_{X} (\mc V_{X}) = T^* _{\Pi} \left (\begin{tikzcd}[row sep = 1 ex] 
\ul{-} & \ul{+} \\
...
\brian{edit this section to emphasize that we aren't fully characterizing the interacting structure, just free limit.}
...
\C[w_1,\ldots, w_4] \otimes \mc{O}\ar[r, "\del_X" description]\ar[dr, "\del_W" description] & \C[w_1,\ldots, w_4]\otimes \Omega^1 \\ & \C[w_1,\ldots, w_4] \{\d w_a\}  \otimes \mc O
\end{tikzcd}
\end{equation}
