...
%\[\mf{osp}(6|2)\to H^\bullet \left ( \Pi \mc E^N_{AdS_4} \left ( \til Z \right ) \right ).\]

We first focus on the case where the flux is zero $N=0$. 
%In this case, we will show that the embedding factors through the natural restriction map from the theory on flat space.
