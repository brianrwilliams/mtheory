...
We will show that the non-minimal twist is equivalent to a theory on $\CC^2 \times \RR^7$ that we call ``Poisson'' Chern--Simons theory, using a direct description of the further twist together with an indirect cohomological argument. This confirms a conjecture in the literature~(\cite{CostelloM5}; see also~\cite{RY}).
