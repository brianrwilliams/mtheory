...
\[
\cV^{(0)} \simeq \T_Z \oplus \lie{sl}(2) \otimes \cO_Z \oplus \Pi \left( \T^*_Z \otimes K^{-1/2}_Z \otimes \C^2 \right).
\]
...
By the compatibility of our decomposition with \cite{KR2} we see that $V_n$ is quasi-isomorphic to the $\infty$-jets of $\cG^{(n)}$ at $0 \in \C^3$. 
