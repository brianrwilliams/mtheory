...
\begin{prop}
  ...
  \[ \operatorname{PExp} \left (\frac{q^{3}\left (\begin{aligned} & t_{1}^{-1}r+t_{1}t_{2}^{-1}r+t_{2}r+q^{-1}r^{-3/2}+qr^{-3/2} \\  - & t_{1}r^{-1}-t_{1}^{-1}t_{2}r^{-1}-t_{2}^{-1}r^{-1}-qr^{3/2}-q^{-1}r^{-3/2}
