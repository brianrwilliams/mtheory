...
We consider the theory on $X = Tot (\R\oplus K_{C})$, with some number of twisted `fivebranes' wrapping the zero section
\[
...
Note that the bundle $\R\oplus K_{C}$ is equipped with a partially flat connection - this data equips the total space $X$ with the data of a transversely holomorphic foliation (THF).
