...
In eleven-dimensional supergravity, the ${\rm AdS}_7 \times S^4$ and ${\rm AdS}_{4}\times S^{7}$ backgrounds are obtained by backreacting a number of fivebranes and membranes respectively in flat space \cite{Maldacena:1997re,WittenAdS}.
In \cite{RSW} we gave descriptions of twisted versions of these backgrounds. We will recall this construction, adapted to a slightly more global situation than is considered in \textit{loc. cit.}.
...
\]
where this identification requires the choice of a fiberwise partially hermitian metric.  
This manifold is equipped with the natural structure of a transversely holomorphic foliation (THF).
We will see that the including the backreaction corresponds to deforming this tructure. 
For sake of analogy, we think of as being a twisted version of $AdS_3 \times S^2$. \footnote{It is an interesting question if this corresponds the actual twist of a five--dimensional supersymmetric background of this form.}
...
If we choose a fiberwise partially hermitian metric on the bundle $\R \oplus K_C$ we obtain a projection $\R \times \T^*C \to \R_{>0} \times C$ which combines the fiberwise norm with the natural bundle projection.
