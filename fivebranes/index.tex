...
\surya{sloppy about hypercohomology}
\begin{prop}
  Up to completion, the cohomology $H^{\bu}(\Gamma(\cA_{\mathring M}^{\bu}(L)), \thfd)$ is a direct sum of the cohomology on flat space $H^{\bu}(\Gamma(\cA)(L), \thfd)$ with the complex
