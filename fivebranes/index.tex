...
\begin{tikzcd}
  + & - \\ \hline
H^\bu \left ( \Gamma ( \cA^{\bu}_{(\R\times\C^2)-0}), \thfd \right )\{\partial_{w_a}, \partial_{z_i}\}  \ar[r, dotted, "D_{\Omega}"] & %H^\bu \left ( \Gamma ( \cA^{\bu}_{(\R\times\C^2)-0}), \thfd \right )  [z_1,z_2,z_3] \\
H^\bu \left ( \Gamma ( \cA^{\bu}_{(\R\times\C^2)-0}), \thfd \right )  \ar[r, dotted, "D"] & H^\bu \left ( \Gamma ( \cA^{\bu}_{(\R\times\C^2)-0}), \thfd \right )  [z_1,z_2,z_3]\{dw_a, dz_i\}
\end{tikzcd}
\eeqn
\end{lem}

Now the THF cohomology
\[
...
\surya{brian can you add something here?}
