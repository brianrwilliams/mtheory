...
H^\bu \left ( \Gamma ( \cA^{\bu}_{(\R\times\C^2)-0}), \thfd \right )\{\partial_{w_a}, \partial_{z_i}\}  \ar[r, dotted, "D_{\Omega}"] & H^\bu \left ( \Gamma ( \cA^{\bu}_{(\R\times\C^2)-0}), \thfd \right )  \\
H^\bu \left ( \Gamma ( \cA^{\bu}_{(\R\times\C^2)-0}), \thfd \right )  \ar[r, dotted, "D"] & H^\bu \left ( \Gamma ( \cA^{\bu}_{(\R\times\C^2)-0}), \thfd \right ) \{dw_a, dz_i\}
\end{tikzcd}
\eeqn
\end{lem}
...
\beqn
(p| \mathring M)_* \cL_{sugra}|_{\infty \times Z}= \Omega^{0,\bu}_Z \otimes \left ( \cO (\C^{2})\otimes V \xrightarrow{D\gamma_{BR}} \Pi (\cO (\C^{2})\otimes V)^{*} \right )
\eeqn
