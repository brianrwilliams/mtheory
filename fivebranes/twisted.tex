...
In any theory of supergravity, there is an collection of bosonic ghosts which, in part, incorporate local supersymmetry.
...
The sheaf of holomorphic functions on $Y$ has a natural lie bracket given by the holomorphic poisson bracket. This can be extended in a graded way to the entire Dolbeault complex; \cL_{5d} is then the tensor product of a commutative algebra and a lie algebra so is canonically a local dg-lie algebra.
