...
\[
\Omega^{\bu}(S) \hotimes \left[ \Omega^{0,\bu}(C, K^{1/4}_C \otimes \C^4) \oplus \Pi \Omega^{0,\bu} (C,K^{3/4}_C \otimes \C^4) \right] .
\]
...
\beqn
\beta \in \Pi \cA_F^\bu, \quad \gamma \in \cA^{1,\bu}_F, \quad \mu \in \Pi \cA^\bu_F(\theta_F), \quad \nu \in \cA_F^\bu  .
\eeqn
