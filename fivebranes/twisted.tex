...
Let $\cA^k(Q), \cA^{k}(Q^{*})$ be the sheaves of $C^\infty$-sections of the bundles $\wedge^k F^{*} \otimes Q$ and $\wedge^{k}F^{*}\otimes Q^{*}$ respectively. Then we have resolutions

\beqn
\vartheta_F \xto{\simeq} \cA^\bu(Q) \\
\Omega^1_F \xto{\simeq}  \cA^\bu(Q^*)
\eeqn
The sheaf $\vartheta_F$ is equipped with a Lie bracket which extends to endow $\cA^\bu(Q)$ the structure of a dg Lie algebra.

We have expressed the fields of the eleven-dimensional theory in terms of a mixed type of de Rham and Dolbeault cohomology. focus on the fields $\beta,\gamma$ which on $S \times X$ combine to form the complex
