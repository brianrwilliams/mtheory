...
\beqn
\int_{S \times X} \left(\gamma \d \mu\right) \Omega_X + \int_{S \times X} (\beta \dbar \nu) \Omega_X + \int_{S \times X} (\beta \div \mu) \Omega_X ,
\eeqn
...
Moreover, the ABJM theories are examples of 3d $\cN=2$ Chern-Simons matter theories, whose twists were studied in \cite{Aganagic:2017tvx}. 
...
\begin{itemize}
  \item The minimal twist. This twist leaves 2 real directions invariant. The theory can be defined on a 3-manifold of the form $S\times C$ where $S$ is a smooth oriented one-manifold and $C$ is a Riemann surface equipped with a fourth-root of its canonical bundle.
