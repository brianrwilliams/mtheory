...
One has
\beqn\label{eqn:MA}
\ch \, \til M_A(\lambda_1,\lambda_3) = q^{y} R(q,r,t_1,t_2) \cdot \ch (V_A^{\lambda_1,\lambda_3}) (t_1^{-1},t_2^{-1},r)
\eeqn
...
\beqn
\ch \til M_A(\lambda_1+j,\lambda_3+j)_{t_1=t_2=1} = R(t,r) t^{2 \lambda_1-3\lambda_3} \frac{(\lambda_1+j+1)(\lambda_1+j+2)}{2} t^{-j} \frac{r^{\lambda_3+j}-r^{-\lambda_3-j-2}}{1-r^{-2}} 
\eeqn
...
\beqn
\ch \til I_A(\lambda_1,\lambda_3) = \frac{q^{\lambda_1-\lambda_3+1}}{1-q} .
\eeqn
