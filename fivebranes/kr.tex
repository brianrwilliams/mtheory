...
There is another auxiliary grading that we will make use of which is also defined in \cite{KR2,KacClass}. 
...
%\eeqn
\beqn
R = \frac{1}{(1-t_1^{-1} q)(1-t_1t_2^{-1}q)(1-t_2 q)}\prod_{a=+1,-1}(1-t_1 q^{1/2} r^a)(1-t_1^{-1} t_2 q^{1/2} r^a)(1-t_2^{-1} q^{1/2} r^a)
\eeqn
\end{lem}
...
%& = \frac{t^{2\lambda_1-3 \lambda_3+6}}{(1-t^2)^3(1-r^{-2})} \left(r^{\lambda_3} p_{\lambda_1}(t^{-1}r) (1-t^{-1}r^{-1})^3 \right. \\ & \left. - r^{-\lambda_3-2} p_{\lambda_1}(t^{-1}r^{-1})(1-t^{-1}r)^3 \right) .
%\end{align*}
...
\beqn
\til p^{\lambda_1} (x,t_1,t_2) = \sum_{j \geq 0} \ch_{SU(3)}^{\lambda_1+j} (t_1^{-1},t_2^{-1}) x^j .
\eeqn
...
One has
\beqn
\til p_{\lambda_1} (t_1,t_2,x) = \frac{p_{\lambda_1}(t_1,t_2,x)}{(1-t_1^{-1} x)(1-t_1t_2^{-1} x)(1-t_2 x)} .
\eeqn
...
\beqn
\til{p}_{\lambda_1}(t_1,t_2,x) = \frac{t_1^{\lambda_1} t_2^{-\lambda_1}}{{(1-t_1^{-1} x)(1-t_1t_2^{-1} x)(1-t_2 x)}} \left(1 + (1 +t_1^{-1}t_2^{-1}- t_1^{-1} x) h(t_1,t_2,x)\right)
\eeqn
...
\ch \til I_A(0,1) = \frac{(r + r^{-1})t^{3} - (t_1 + t_1^{-1} t_2 + t_2^{-1} )t^4 + t^6}{(1-t_1^{-1}t^2) (1-t_1 t_2^{-1} t^2) (1-t_2 t^2)} .
\eeqn
\end{cor}

We note that upon substituting $q = t^2$ this agrees with $\chi_{\lie{u}(1)}^{6d}(t_1,t_2,q,r)$---the character of local operators on the holomorphic twist of the abelian six-dimensional superconformal theory, see Proposition \ref{prop:6done}.
...
\ch \til I_A(1,0) = \frac{t^8(t_1^{-1} + t_1 t_2^{-1}  + t_2) + t^6 (r^2 + r^{-2} + 1) - t^{7} (r + r^{-1})(t_1 + t_1^{-1} t_2 + t_2^{-1})}{(1-t_1^{-1}t^2) (1-t_1 t_2^{-1} t^2) (1-t_2 t^2)} .
\eeqn
\end{cor}

Again, we note that upon substituting $q = t^2$ this agrees with $\chi_{\lie{sl}(2)}^{6d}(t_1,t_2,q,r)$---the character of local operators on the holomorphic twist of our conjectural description of the six-dimensional superconformal theory associated to the Lie algebra $\lie{sl}(2)$, see Proposition \ref{prop:6dtwo}.

We will see how these agreements for small values of $\lambda_1,\lambda_3$ fit into a more general relationship between the irreducible modules $\til I_A(\lambda_1,\lambda_3)$ and $\til I_{B} (\lambda_1,\lambda_3)$ and local operators of the universal fivebrane theory in \S \ref{s:kacfivebrane}. 
...
%One has
%\beqn\label{eqn:MA}
%\ch \, \til M_B(\lambda_1,\lambda_3) = t^{y_B} R(t,r,t_1,t_2) \cdot \ch (V_B^{\lambda_1,\lambda_3}) (t_1^{-1},t_2^{-1},r)
%\eeqn
%where $y_B = 2\lambda_1 + 3 \lambda_3+6$, $R$ is as in Lemma \ref{lem:R} and
%\beqn\label{eqn:suB}
%\ch(V_B^{\lambda_1,\lambda_3})(t_1,t_2,r) = \ch_{SU(3)}^{\lambda_1}(t_1,t_2) \ch_{SU(2)}^{\lambda_3} (r) 
%\eeqn
%is the $SU(3) \times SU(2)$ character of the representation $V_B^{\lambda_1,\lambda_3}$.
%\end{prop}
