...
Given these formulas we see that we need to compute the sum
\begin{multline}
\sum_{j \geq 0} t^j \left(r^{\lambda_3+j}-r^{-\lambda_3-j-2}\right) \sum_{k=0}^{\lambda_1 + j}t_1^{2k} t_2^{-k} \frac{1 - t_1^{-k-1} t_2^{-k-1}}{1-t_1^{-1} t_2^{-1}}  \\
= \frac{1}{1-t_1^{-1} t_2^{-1}} \sum_{j\geq 0} t^j \left(r^{\lambda_3+j}-r^{-\lambda_3-j-2}\right) \sum_{k=0}^{\lambda_1 + j} t_1^{2k} t_2^{-k} \left(1 - (t_1t_2)^{-k-1}\right) \\
= \sum_{k=0}^{\lambda_1+j} \sum_{l=0}^k 
\end{multline}
