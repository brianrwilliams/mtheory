...
Perturbatively, the phase space is described by the following local Lie algebra. 
\beqn
\begin{tikzcd}
\underline{-2} & \underline{-1} & \underline{0} \\
& \Omega_S^{0,\bullet}\arrow[dd, "c_1(L)\wedge\partial"] & \\
\Omega_S^{0,\bullet}(L_2)& & \Omega^{0,\bullet}_S(L_1\otimes L_2) \\
& \Omega_S^{0,\bullet}(K_S)  &
\end{tikzcd}
\eeqn
...
\beqn
\begin{tikzcd}
S\times TFS_1 (S)\ar[r, "\pi_2"]\ar[d, "\pi_1"] & TFS_1 (S) \\
S
\end{tikzcd}
\eeqn
