...
Let $\cL$ be the 
We consider the following two automorphisms  
...
The other action is of infinite order, and is related to the BCOV action functional via the procedure outlined above \ingmar{or somewhere}. Explicitly, this action functional is given by 
\deq{
