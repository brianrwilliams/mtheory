...
\deq{
  S_\strict = \int^\Omega \beta (\dbar + \d_L) \nu + \int^\Omega \gamma (\dbar + \d_L) \mu + \int^\Omega \beta\partial_\Omega \mu + \frac{1}{2} \int^\Omega \gamma [\mu,\mu] + \int^\Omega \beta[\mu,\nu].
}
...
\deq{
  S_\infty = \int^\Omega \beta (\dbar + \d_L) \nu + \int^\Omega \gamma (\dbar + \d_L) \mu + \frac12 \int^\Omega \beta \partial_\Omega \mu + \int^\Omega\frac{1}{1-\nu} (\partial \gamma) \mu^2.
}
...
\[
\int^\Omega \alpha_1 \wedge \cdots \wedge \alpha_m \wedge \beta_1 \wedge \cdots \wedge \beta_n  .
\]
