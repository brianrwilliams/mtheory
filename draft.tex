...
\begin{thm}
There is a map of super Lie algebras from the super Lie algebra $E^{hol}(5,10)$ to the Lie algebra of gauge symmetries of the 11-dimensional theory on $\CC^5 \times \RR$. 
This map is an embedding at the level of cohomology. 
\end{thm}
