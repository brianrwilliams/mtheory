...
\begin{conj}
\label{conj:5dsugra}
The twist of 5d supergravity (with nonzero Chern--Simons term) with vector multiplets valued in a Lie algebra $\fg$ and hypermultiplets valued in a representations $V$ has BV fields
\begin{itemize}
