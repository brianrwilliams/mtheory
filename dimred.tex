...
The sum of the action functionals \eqref{eqn:bfred} and \eqref{eqn:jred} do not precisely agree with the IIA action $\til I_{IIA}$. 
To relate these we must make the following field redefinition:
\[
