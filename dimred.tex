...
I_{IIA} = \int^\Omega_{\CC^4 \times \RR^2} \frac{1}{1-\nu} \mu^2 \wedge \Pi + \int^\Omega_{\CC^4 \times \RR^2} \frac{1}{1-\nu} \eta \wedge \mu \wedge \sigma + \int^\Omega_{\CC^4 \times \RR^2} \frac{1}{1-\nu} \eta \wedge \Pi^2 + \cdots 
\eeqn
...
u^{-1}{\PV^{4,\bu} (\CC^4) \otimes \Omega^\bu (\RR^2)}_\beta \arrow[r, "u\div"] & {\PV^{3,\bu} (\CC^4) \otimes \Omega^\bu (\RR^2)}_\gamma  \\
{\PV^{4,\bu} (\CC^4) \otimes \Omega^\bu (\RR^2)}_\theta &
\end{tikzcd}
\eeqn.
...
The pairing is $\Res_u \frac{\d u}{u} \int^\Omega_{\CC^4 \times \RR^2} \alpha \wedge \alpha'$ where $\alpha, \alpha'$ are two general fields in this potential theory on $\CC^4 \times \RR^2$. 
...
\til I_{IIA} = \int^\Omega_{\CC^4 \times \RR^2} \frac{1}{1-\nu} \mu^2 \wedge \div \gamma + \int^\Omega_{\CC^4 \times \RR^2} \frac{1}{1-\nu} \eta \wedge \mu \wedge \div \theta + \int^\Omega_{\CC^4 \times \RR^2} \frac{1}{1-\nu} \eta \wedge \div \gamma \wedge \div \gamma 
\eeqn
