...
\begin{tikzcd}[row sep=large]
                                                                         &  \parbox{3cm}{\centering minimal twist of 11d} \arrow[ld, "\text{topological }S^1" '] \arrow[d, "\text{slab }" '] \arrow[rdd, "\text{CY3}" ' pos=.75] \arrow[rr, rightsquigarrow] \arrow[rd, "\text{holomorphic }S^1"] &                                                             &  \parbox{3cm}{\centering non-minimal twist of 11d} \arrow[d, "\text{topological }S^1"] \\
 \parbox{3cm}{\centering minimal twist of type IIA} \arrow[r, "\text{orbifold}"] &  \parbox{3cm}{\centering minimal twist of type I} \arrow[r, rightsquigarrow, crossing over]                                                                                                                                                                                               &  \parbox{3cm}{\centering SU(4) twist of type IIA} \arrow[r, rightsquigarrow] &  \parbox{3cm}{\centering SU(2) twist of type IIA}                                                 \\
