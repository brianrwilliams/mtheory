...
In \S\ref{sec:dfn} we introduce a full interacting theory in th Batalin--Vilkovisky (BV) formalism which has, as its free limit, the twist computed in \cite{SWspinor}.\footnote{One subtlety is that unlike the usual BV formalism which involves a $\ZZ$-grading by ghost number, the 11-dimensional theory is only $\ZZ/2$ graded.
...
\begin{conj}
The $11$-dimensional partially holomorphic-topological theory on $\CC^5 \times \RR$ that we will define in \S \ref{sec:dfn} is equivalent to twisted supergravity on $\RR^{11}$ where the bosonic ghost takes value the holomorphic supercharge. 
\end{conj}
...
In Table \ref{diagram}, we provide a summary of the comparisons with twists of supergravity in lower dimensions we perform. The squigly arrows denote further twists, and the solid arrows denote various kinds of reductions. 

\begin{center}
\begin{tikzcd}[row sep=large]
                                                                         &  \parbox{3cm}{\centering minimal twist of 11d} \arrow[ld, "\text{topological }S^1" '] \arrow[d, "\text{slab }" '] \arrow[rdd, "\text{CY3}" description, pos=.5] \arrow[rr, rightsquigarrow] \arrow[rd, "\text{holomorphic }S^1"] &                                                             &  \parbox{3cm}{\centering non-minimal twist of 11d} \arrow[d, "\text{topological }S^1"] \\
 \parbox{3cm}{\centering minimal twist of type IIA} \arrow[r, "\text{orbifold}"]\arrow[rr, rightsquigarrow, bend right=25, crossing over]                                                                                                                                                                                               &  \parbox{3cm}{\centering minimal twist of type I}  &  \parbox{3cm}{\centering SU(4) twist of type IIA} \arrow[r, rightsquigarrow] &  \parbox{3cm}{\centering SU(2) twist of type IIA}                                                 \\
